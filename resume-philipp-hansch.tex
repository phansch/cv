...
\begin{itemize}
  \setlength{\itemsep}{0cm}
  \setlength{\parskip}{0cm}
  \item[] \emph{WebCal} \hfill \href{https://github.com/BatchZero/Webcal}{Source on GitHub}

  \item[] A Webcalendar App using a Backbone.js front-end and a Rails 4 back-end.
\end{itemize}
...
\begin{itemize}
  ...
  \item[] Exposure to: Rust, Python, C, C++, Javascript
\end{itemize}
